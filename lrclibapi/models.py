...
class LyricsMinimal(BaseModel["LyricsMinimal"]):
    ...
    duration: int
    instrumental: bool
    plain_lyrics: str | None = field(default=None, repr=False)
    synced_lyrics: str | None = field(default=None, repr=False)
...
class Lyrics(BaseModel["Lyrics"]):
    ...
    plain_lyrics: str | None = field(default=None, repr=False)
    synced_lyrics: str | None = field(default=None, repr=False)
    lang: str | None = field(default=None, repr=False)
    isrc: str | None = field(default=None, repr=False)
    spotify_id: str | None = field(default=None, repr=False)
    release_date: datetime | None = field(default=None, repr=False)
